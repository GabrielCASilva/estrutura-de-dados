 ...
 *
 * Adiciona um novo elemento no início do deque, ajustando os índices conforme
 * necessário.
 *
 * @param deque Ponteiro para o deque.
 ...
 *
 * Adiciona um novo elemento no final do deque, ajustando os índices conforme
 * necessário.
 *
 * @param deque Ponteiro para o deque.
 * @param item Elemento a ser inserido.
 ...
 *
 * Reseta os índices e a quantidade de elementos, efetivamente esvaziando o
 * deque.
 *
 * @param deque Ponteiro para o deque.
 */
